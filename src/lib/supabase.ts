...
if (!isSupabaseConfigured) {
  console.warn(
    'Supabase environment variables are missing or invalid. Database features will not work. Ensure VITE_SUPABASE_URL and VITE_SUPABASE_ANON_KEY (anon JWT or sb_publishable_*) are correctly set in your deployment environment. Do not use sb_secret_* keys in the browser.'
  );
}
